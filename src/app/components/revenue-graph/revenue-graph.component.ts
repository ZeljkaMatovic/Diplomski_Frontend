...
export class RevenueGraphComponent implements OnInit {
  ...
  constructor(public service: AirlineService) {
    ...
    service.findAirline(this.admin.serviceId).subscribe(
      (res: any) => {
        console.log(res)
  ...
  submitInput() {
    ...
    this.service.getTicketsByAirline(1, this.airline.nameOfAirline, input, "revenue").subscribe(
      (res: any) => {
  ...
  submitInput2() {
    ...
    this.service.getTicketsByAirline(2, this.airline.nameOfAirline, this.dateString, "revenue").subscribe(
      (res: any) => {
  ...
  submitInput3() {
    ...
    this.service.getTicketsByAirline(3, this.airline.nameOfAirline, inputSplit[1], "revenue").subscribe(
      (res: any) => {
